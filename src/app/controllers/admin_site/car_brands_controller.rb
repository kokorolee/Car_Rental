...
class AdminSite::CarBrandsController < AdminSite::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @car_brand.save
        format.html { redirect_to admin_site_car_brand_path(@car_brand), notice: 'Car brand was successfully created.' }
      else
  ...
  def update
    respond_to do |format|
      if @car_brand.update(car_brand_params)
        format.html { redirect_to redirect_to admin_site_car_brand_path(@car_brand), notice: 'Car brand was successfully updated.' }
      else
  ...
  def destroy
    @car_brand.destroy
    respond_to do |format|
      format.html { redirect_to admin_site_car_brands_path, notice: 'Car brand was successfully destroyed.' }
